package com.akv.newsiebuild.adapter;
...
import com.akv.newsiebuild.activity.ReadLaterActivity;
                ...
                if (articleListFiltered.size() == 0) {
                    ...
                    if (txt == null || txt.length() == 0) {
                        ...
                        for (ArticlesItemDB item : articleListFiltered) {
                            if (item.getTitle().toLowerCase().contains(filterPattern)) filteredList.add(item);
                        }
                    ...
                    if (filteredList.size() == 0) {
                        ...
                        Snackbar.make(mRecyclerView, filterPattern + " yield no result", Snackbar.LENGTH_LONG).show();
                    } else {
